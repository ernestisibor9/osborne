 ...
 <div class="col-md-10 col-sm-10 mt-4 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        @endif
        <form method="POST" action="{{ route('osborn-service-category.store') }}" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data" autocomplete="off">
            @csrf
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
             ...
             {{-- <textarea name="name" class="form-control" rows="3" col="3" placeholder="write your category name" value="{{ old('name') }}" required></textarea> --}}
