            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-user"></i> Finacial Adversory <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('admin-dashboard.register') }}">M</a></li>
                      <li><a href="{{ route('admin-dashboard.index') }}">View Users</a></li>
                    </ul>
                  </li>


                   <li><a><i class="fa fa-users"></i> Security Tradings <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('about.create') }}">Add About</a></li>
                      <li><a href="{{ route('about.admin-page') }}">View About</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-upload"></i>Market files Upload <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('upload-files.top-gain') }}">Top Gainers </a></li>
                      <li><a href="{{ route('upload-files.top-loser') }}">Top Loosers </a></li>
                      <li><a href="#">Market Summary </a></li>
                    </ul>
                  </li>

                    <li><a><i class="fa fa-upload"></i>PDF files Mgt <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('pdf-download.create') }}">Upload File </a></li>
                      <li><a href="{{ route('pdf-download.index') }}">Uploaded Files </a></li>
                      <li><a href="#">Market Summary </a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-users"></i> Wealth Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('team.create') }}">Add Teams</a></li>
                      <li><a href="{{ route('team.index') }}">View Teams</a></li>
                    </ul>
