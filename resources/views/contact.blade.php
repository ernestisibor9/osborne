                    ...
                    <div class="form-section">
                        <form class="contact-form" method="POST" action="{{ route('email.ContactMail') }}">
                            ...
                            <div class="form-group">
                                <input id="name" name="first_name" type="text" class="form-control"  required="" placeholder="First Name">
                            </div>

                            <div class="form-group">
                                <input id="last-name" name="sur_name" type="text" class="form-control"  required="" placeholder="Sur Name">
                            </div>
